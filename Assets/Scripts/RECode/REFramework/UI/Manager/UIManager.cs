...
namespace RECode.REFramework
{
    ...
    public class UIManager : MonoSingleton<UIManager>
    {
        ...
        protected override void Awake()
        {
            base.Awake();
            //在预设体加载canvas
            GameObject staticCanvasObj = ResourcesManager.Instance.Load<GameObject>($"{prefabPath}/StaticCanvas");
            GameObject dynamicCanvasObj = ResourcesManager.Instance.Load<GameObject>($"{prefabPath}/DynamicCanvas");
            ...
            //在预设体加载eventsystem
            GameObject obj = ResourcesManager.Instance.Load<GameObject>($"{prefabPath}/EventSystem");
        ...
        public void ShowPanel<T>(string panelName,E_UI_Canvas targetCanvas,E_UI_Layer layer = E_UI_Layer.Mid, UnityAction<T> callback = null) where T : BasePanel
        {
            ...
            ResourcesManager.Instance.LoadAsync<GameObject>($"{prefabPath}/Panels/" + panelName, (obj) =>
            {
                //把他设置为canvas的子对象
                //并且设置相对位置
